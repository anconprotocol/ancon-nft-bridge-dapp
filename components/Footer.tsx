    ...
    <div>
      <div className="w-full lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
        <div className="container mx-auto ">
          <div className="xl:flex flex-wrap justify-center flex-col items-center  p-10">
            <div className="lg:w-6/12 mb-10">
              <ul className="xl:flex lg:flex md:flex sm:flex justify-between font-bold text-gray-400">
                <Link href={"/"} passHref>
                  <li className=" hover:text-gray-900 text-base mb-4 sm:mb-0 mr-4">
                    <a>Index</a>
                  </li>
                </Link>
                ...
                <Link href={"/enroll"} passHref>
                  <li className=" hover:text-gray-900 text-base mb-4 sm:mb-0">
                    <a>Enroll</a>
                  </li>
                </Link>
            ...
            <div className="w-11/12 xl:w-1/6 lg:w-1/6 sm:w-11/12 mx-auto lg:mx-0 xl:mx-0 mb-6 lg:mb-0 xl:mb-0 mt-8 lg:mt-8 xl:mt-0">
              <div className="flex justify-start sm:justify-center xl:justify-between space-x-6 pr-2 xl:pr-0 lg:pr-0 md:pr-0 sm:pr-0">
                <div>
                  <a>
                    <svg
                      width="20"
            ...
            <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0 mt-8 flex justify-center items-center">
              <p className="text-gray-400 text-base">
                © 2020 NFTAncon, Inc. Created by{" "}
                <a className="text-primary-500 cursor-pointer">
                  Ancon Protocol{" "}
                </a>
              </p>
            </div>
